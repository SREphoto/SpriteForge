...
**1. Core Attributes:**
   ...
   - Briefly define what each attribute governs.
...
**2. Derived Stats:**
   ...
   - Explain how some of these might be calculated or influenced by core attributes.

**3. Resource System(s):**
   - Describe the primary resource(s) this class uses for abilities (e.g., Mana, Rage, Energy, Stamina, Soul Shards).
   - How is this resource generated and consumed?
...
Consider a mix of:
   ...
   - Proc effects (e.g., "Chance on hit to cast X", "On kill, gain Y")
   - Skill bonuses (e.g., "+1 to [Specific Skill]")
...
**3. Key Parameters (Examples - adjust as needed for the concept):**
   - **Damage Type (if applicable):** (e.g., Fire, Cold, Physical, Arcane)
   - **Damage/Healing Amount (Conceptual):** (e.g., "Moderate," "High burst," "Scales with Magical Power")
   - **Area of Effect (if applicable):** (e.g., Single Target, Cone, Radius around caster, Projectile)
   - **Resource Cost (Conceptual):** (e.g., "Low Mana," "Significant Rage," "Uses 1 Charge")
   - **Cooldown (Conceptual):** (e.g., "Short," "Long," "No Cooldown")
   - **Casting Time/Speed (Conceptual):** (e.g., "Instant," "Short Cast," "Channeled")
...
**4. Potential Upgrade Paths or Synergies (1-2 ideas):**
   - How could this spell/ability be improved or modified through a skill tree or item effects?
`;
      break;
    default:
